    ...
    <div className="w-full px-12 flex justify-center">
      <div className="flex flex-col justify-center items-center h-svh py-10 w-full">
        <div className="flex justify-center w-full">
          <h1 className="bytewave-heading">Bytewave</h1>
        </div>
        <div className="w-full flex justify-center">
          <div className="grid items-center gap-1.5 mt-40 ml-6 w-[500px]">
            <div className="bytewave-heading font-mulish-regular text-gray-700 mb-1">Super Admin</div>
            <p className="bytewave-paragraph text-gray-400 mb-4">Sign in to manage tenant apps on the platform</p>
