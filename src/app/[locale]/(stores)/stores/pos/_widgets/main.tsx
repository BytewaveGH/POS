                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            unitInCart
                                ...
                                : 'border-gray-200 hover:border-endeavour/60'
                        )}
                    >
                        <div>
                            <span className="text-sm font-semibold text-stone-700">
                                {unit.label}
                                {unitInCart && (
                                    <span className="ml-2 bg-endeavour text-white text-[10px] rounded-full px-2 py-0.5">
                                        {unitInCart.quantity} in cart
                                    </span>
                                )}
                            </span>
    ...
    const CartControls = () => (
        <div className="px-4 py-3 border-b border-gray-100 flex-shrink-0">
            ...
            <p className="text-[9px] text-gray-400 mt-1.5 text-center">
                Box & carton pricing only · Pieces priced by quantity rules
            </p>
        </div>
    )
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        overStock && 'bg-red-50 -mx-2 px-2 rounded-xl'
                                    )}
                                >
                                    ...
                                    <p className="text-stone-700 text-sm font-bold w-16 text-right flex-shrink-0">
                                        ₵{lineTotal.toFixed(2)}
                                    </p>
                                    <button
        ...
        <div className="w-full h-[calc(100vh-5rem)] flex flex-col overflow-hidden">
                        ...
                        {isLoading ? (
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 pb-4">
                                {Array.from({ length: 8 }).map((_, i) => (
                                    <div
                                        key={i}
                                        className="rounded-2xl border border-gray-100 bg-gray-50 animate-pulse"
                                ...
                                {filtered.map((product: Product) => {
                                    ...
                                    const cardInner = (
                                        <>
                                            ...
                                            <div className="w-full aspect-square rounded-xl bg-gray-50 mb-2.5 flex items-center justify-center text-2xl">
                                                🛒
                                            </div>
                                            <div>
                                                <p className="text-stone-700 font-semibold leading-tight line-clamp-2 text-xs">
                                                    {product.name}
                                                </p>
                                        ...
                                        <div key={product.id}>
                                            ...
                                            {isMultiUnit ? (
                                                <PopoverTemplate
                                                    ...
                                                    trigger={
                                                        <div className={cn(cardClassName, 'hidden md:flex flex-col')}>
                                                            {cardInner}
                                                        </div>
                                                    }
                                                    content={
                                                ...
                                                <div
                                                    className={cn(cardClassName, 'hidden md:flex flex-col')}
                                                    onClick={() => addToCart(product, primaryUnit)}
                                                >
                                                    {cardInner}
                                                </div>
                                            )}
            ...
            <button
                className={cn(
                    ...
                    cartCount > 0
                        ? 'bg-endeavour text-white active:bg-veniceBlue'
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                        ...
                        {cartCount > 0 && (
                            <p className="text-xs opacity-75">Tap to view & checkout</p>
                        )}
                    </div>
                </div>
                {cartCount > 0 && (
            ...
            <Sheet open={cartSheetOpen} onOpenChange={setCartSheetOpen}>
                <SheetContent
                    side="bottom"
                    className="p-0 gap-0 rounded-t-3xl max-h-[92dvh] flex flex-col"
                >
                    {/* Drag handle */}
            ...
            <Sheet
                ...
                onOpenChange={open => { if (!open) setUnitPickerProduct(null) }}
            >
                <SheetContent
                    side="bottom"
                    className="p-0 gap-0 rounded-t-3xl"
                >
                    {/* Drag handle */}
                    ...
                    <div className="px-4 pb-8">
                        {unitPickerProduct && <UnitList product={unitPickerProduct} />}
                    </div>
                </SheetContent>
            </Sheet>
        </div>
