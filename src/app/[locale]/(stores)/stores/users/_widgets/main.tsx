...
const AVATAR_COLORS = [
    'bg-endeavour', 'bg-green-500', 'bg-purple-500',
...
const Main = () => {
    ...
    const { data: employeesRaw, isLoading, refetch } = useFetchData(
        'employees',
        EmployeeServices.FetchAll() as unknown as IGeneric
    )
    ...
    const openEdit   = (emp: any) => { setSelected(emp); setModalOpen(true) }
    const handleClose = () => { setModalOpen(false); setSelected(null) }

    const handleDelete = async (id: number) => {
        try { await request(EmployeeServices.Delete(id)); refetch() }
        ...
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    ...
                    <p className="bytewave-paragraph text-gray-500">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col gap-2">
                    ...
                    <p className="bytewave-heading text-2xl text-stone-800">
