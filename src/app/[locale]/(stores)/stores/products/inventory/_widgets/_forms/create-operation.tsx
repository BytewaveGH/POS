    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full">
        <div className="flex flex-col gap-4 py-2 flex-1">
          <InputsTemplate control={form.control} name="name" label="Operation Name" placeholder="e.g. Monthly Rent" isRequired />
          ...
          <div className="grid grid-cols-2 gap-4">
            <InputsTemplate control={form.control} name="amount" label="Amount (₵)" placeholder="0.00" inputType="number" isRequired />
            <InputsTemplate control={form.control} name="date" label="Date" placeholder="YYYY-MM-DD" inputType="date" isRequired />
          </div>
        </div>
