...
const SearchableUnitSelect = ({ value, onChange, options, placeholder = 'Select product' }: SearchableUnitSelectProps) => {
    ...
    return (
        <div ref={containerRef} className="relative" onBlur={handleBlur}>
            ...
            >
                <span className={selectedLabel ? 'text-stone-700 truncate' : 'text-gray-400'}>
...
const CreateInvoice = ({ onSuccess }: CreateInvoiceProps) => {
    ...
    const onSubmit = async (data: InvoiceForm) => {
        ...
        try {
            ...
            form.reset({ customerName: '', customerPhone: '', date: today, paymentType: 'cash', items: [{ productUnitId: 0, quantity: 1, pricingType: 'retail' }] })
            onSuccess?.()
        } catch (err: any) {
                            ...
                            {fields.map((field, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        />
                                        {/* Unit price */}
                                        <span className="bytewave-paragraph text-sm text-stone-700">
